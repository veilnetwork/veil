...
> Kept beside `release-signing.md` because it is the other half of the same
> question: that one says how a build is signed, this one says what must be
> filled in before the tree is published at all. It was written 2026-08-27 and
> lived outside the repository until 2026-09-13, which is the wrong place for a
> checklist whose whole purpose is to be found by whoever publishes next.
