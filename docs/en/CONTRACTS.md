...
- **Replay protection**: the destination node keeps a 32-second replay window keyed on `content_id`. A peer that replays a message outside that window gets banned.
