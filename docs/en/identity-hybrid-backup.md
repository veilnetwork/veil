...
- [`docs/identity-model.md`](identity-model.md) — the canonical sovereign-identity spec
  (master + delegations + auto-reissue).
- [`docs/recovery.md`](recovery.md) — classical (Ed25519-only) recovery flow.
- [`docs/SECURITY.md`](SECURITY.md) — operator-side threat model and mitigations.
