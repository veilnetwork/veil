 ...
 */
#define VEIL_ABI_CONTRACT_HASH_LEN 64
...
int veil_provision_hybrid_identity_from_credential_zeroize(const uint8_t *credential,
...
int veil_identity_document_master(const uint8_t *document,
                                  uintptr_t document_len,
                                  uint8_t *out_algo,
                                  uint8_t *out_pubkey,
                                  uintptr_t out_cap,
