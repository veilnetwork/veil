...
pub(crate) const NAT_PROBE_SUSTAINED_PER_SEC: f64 = 1.0 / 600.0;
...
pub(crate) const NAT_PROBE_BURST: f64 = 3.0;
...
pub(crate) const NAT_PROBE_IDLE_FORGET: std::time::Duration = std::time::Duration::from_secs(3600);
