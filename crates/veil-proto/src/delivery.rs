...
///
/// Wire layout (fixed header = 180 bytes):
/// ```text
/// [0..32] recipient_node_id [u8; 32]
/// [32..64] sender_node_id [u8; 32]
/// [64..96] src_app_id [u8; 32]
/// [96..128] app_id [u8; 32] (destination)
/// [128..132] endpoint_id u32 BE (destination)
/// [132..164] content_id [u8; 32]
/// [164..172] created_at u64 BE (Unix timestamp, secs)
/// [172..176] ttl_secs u32 BE (high bit = DELIVERY_FLAG_REQUIRE_ACK)
/// [176..180] payload_len u32 BE
/// [180..180+plen] payload bytes
/// ```
///
