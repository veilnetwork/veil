...
mod tests {
    ...
    fn dht_key_is_stable_normalized_and_distinct() {
        assert_eq!(nickname_dht_key("ALICE"), nickname_dht_key("  alice "));
        assert_ne!(nickname_dht_key("alice"), nickname_dht_key("alicea"));
        // The full key is domain-separated from the bare name hash.
        assert_ne!(nickname_dht_key("alice"), nickname_key("alice"));
