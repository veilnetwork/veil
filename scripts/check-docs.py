...
CONFIG = {
    ...
    # two completed migration plans and two maintainer checklists. If one of
    # these is ever translated, delete its line — the gate will not mind.
    "parity_exempt": {
        "docs/en/PLAN_IPC_STREAM_FORWARDING.md",
